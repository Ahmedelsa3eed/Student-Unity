...
export class CourseCardComponent implements OnInit {
  ...
  deleteCourse(): void {
    this.allCoursesService.deleteCourse(this.signInOutService.getSignedInUserSessionID(), this.course.code).subscribe({
      next: (res) => {
        console.log(res);
        location.reload();
      },
  ...
  subscribeCourse(): void {
    this.allCoursesService.registerCourse(this.signInOutService.getSignedInUserSessionID(), this.course.id).subscribe({
      next: (res) => {
        console.log(res);
